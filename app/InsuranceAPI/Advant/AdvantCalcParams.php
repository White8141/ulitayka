...
class AdvantCalcParams
{
    ...
    public function getCalcParams($request)
    {
        ...
        $this->policyPeriodFrom = Carbon::createFromFormat('d.m.Y', $request['dateFrom'])->addYear(1);//->toDateString();
        $this->policyPeriodTill = Carbon::createFromFormat('d.m.Y', $request['dateTill'])->addYear(1);//->toDateString();
