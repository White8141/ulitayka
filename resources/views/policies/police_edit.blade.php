    ...
    <div class="container">
            ...
            <div class="police_details">
                <form action="{{ route('policy_save') }}" method="post" class="details-form" id="form_details" name="form_details">
                    ...
                    <input type="radio" name="policy_currency" value="EUR" id="radio_euro" class="check_and_radio" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')" checked>
                    <label for="radio_euro" style="margin-right: 20px;">Евро</label>
                    <input type="radio" name="policy_currency" value="USD" id="radio_usd"  class="check_and_radio" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')">
                    ...
                    <div class="medical_amount">
                        ...
                        <input type="radio" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')" name="risks[0][risk_amount]" value="50000" id="radio_medical_amount_50000" class="check_and_radio" checked><label for="radio_medical_amount_50000" style="margin-right: 20px;">50&nbsp;000&nbsp;<p class="currency_symbol">&#8364;</p></label>
                        <input type="radio" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')" name="risks[0][risk_amount]" value="100000" id="radio_medical_amount_100000" class="check_and_radio" ><label for="radio_medical_amount_100000">100&nbsp;000&nbsp;<p class="currency_symbol">&#8364;</p></label><br>
                    </div>
                    ...
                    <div id="toggle_options_list">
                        ...
                        <div class="margined">
                            ...
                            <input type="radio" value="3000" name="risks[3][risk_amount]" id="radio_accident_3000" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                            ...
                            <input type="radio" value="5000" name="risks[3][risk_amount]" id="radio_accident_5000" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                            ...
                            <input type="radio" value="10000" name="risks[3][risk_amount]" id="radio_accident_10000"  onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                        ...
                        <div class="margined">
                            ...
                            <input type="radio" value ="1000" name="risks[4][risk_amount]" id="radio_laggage_1000" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                                   class="check_and_radio" disabled><label for="radio_laggage_1000" class="margined_text"
                                                                           style="margin-right: 20px;">1&nbsp;000<p class="currency_symbol">€</p></label>
                            <input type="radio" value ="1500" name="risks[4][risk_amount]" id="radio_laggage_1500" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                            ...
                            <input type="radio" value ="2000" name="risks[4][risk_amount]" id="radio_laggage_2000" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                        ...
                        <div class="margined">
                            ...
                            <input type="radio" value="1000" name="risks[2][risk_amount]" id="radio_cancel_1000" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                            ...
                            <input type="radio" value="1500" name="risks[2][risk_amount]" id="radio_cancel_1500" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                            ...
                            <input type="radio" value="2000" name="risks[2][risk_amount]" id="radio_cancel_2000" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                            ...
                            <input type="radio" value="2500" name="risks[2][risk_amount]" id="radio_cancel_2500" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                            ...
                            <br>
                            <input type="radio" value="3000" name="risks[2][risk_amount]" id="radio_cancel_3000" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                            ...
                            <input type="radio" value="3500" name="risks[2][risk_amount]" id="radio_cancel_3500" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                            ...
                            <input type="radio" value="4000" name="risks[2][risk_amount]" id="radio_cancel_4000" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                            ...
                            <input type="radio" value="4500" name="risks[2][risk_amount]" id="radio_cancel_4500" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                            ...
                            <input type="radio" value="5000" name="risks[2][risk_amount]" id="radio_cancel_5000" onchange="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                        ...
                        <div class="margined">
                            ...
                            <input type="radio" name="risks[1][risk_amount]" value="30000" id="radio_civil_responsibility_30000" onclick="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')"
                            ...
                            <input type="radio" name="risks[1][risk_amount]" value="50000" id="radio_civil_responsibility_50000" onclick="chDetails('{{route('calcajax')}}', '{{csrf_token()}}')" checked
