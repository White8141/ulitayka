...
@section('content')
    <div class="container">
        ...
        <section class="content">
            ...
            <div class="title">
                <div class="content_legend_back out"></div>
                <h1>Легенда</h1>
                <hr>
            </div>
            <div class="boxForContent boxForContentOne">
                ...
                <div class="boxForImg">
                    <div class="imgMagicYo"></div>
                    <div class="imgMagicYo absoluteImgRight"></div>
                    <div class="imgMagicYo"></div>
                    <div class="imgMagicYo absoluteImgRight absoluteImgRightSecond"></div>
                </div>
            </div>
