...
Vue.component('dis-card', require('./components/DisCard.vue').default);
Vue.component('ins-form', require('./components/InsuranceForm.vue').default);
...
var vm = new Vue ({
    ...
    computed: {
        cardArray: function () {
            dataArray = this.requestArray.filter(function (item) {
                return +item.prem > 0;
            });
